...
CREATE TABLE WAREHOUSE (
  W_ID bigserial DEFAULT '0' NOT NULL,
...
CREATE TABLE DISTRICT (
  D_ID bigserial DEFAULT '0' NOT NULL,
  D_W_ID bigserial DEFAULT '0' NOT NULL REFERENCES WAREHOUSE (W_ID),
...
CREATE TABLE CUSTOMER (
  C_ID bigserial DEFAULT '0' NOT NULL,
  C_D_ID bigserial DEFAULT '0' NOT NULL,
  C_W_ID bigserial DEFAULT '0' NOT NULL,
...
CREATE TABLE ORDER (
  O_ID bigserial DEFAULT '0' NOT NULL,
  O_C_ID bigserial DEFAULT NULL,
  O_D_ID bigserial DEFAULT '0' NOT NULL,
  O_W_ID bigserial DEFAULT '0' NOT NULL,
...
CREATE TABLE ITEM (
  I_ID bigserial DEFAULT '0' NOT NULL,
...
CREATE TABLE ORDER_LINE (
  OL_O_ID bigserial DEFAULT '0' NOT NULL,
  OL_D_ID bigserial DEFAULT '0' NOT NULL,
  OL_W_ID bigserial DEFAULT '0' NOT NULL,
  OL_NUMBER bigserial DEFAULT '0' NOT NULL,
  OL_I_ID bigserial DEFAULT NULL,
  OL_SUPPLY_W_ID bigserial DEFAULT NULL,
...
CREATE TABLE STOCK (
  S_I_ID bigserial DEFAULT '0' NOT NULL REFERENCES ITEM (I_ID),
  S_W_ID bigserial DEFAULT '0 ' NOT NULL REFERENCES WAREHOUSE (W_ID),
